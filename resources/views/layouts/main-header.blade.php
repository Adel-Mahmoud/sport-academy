	...
	<div class="container-fluid">
		<div class="main-header-left ">
			<div class="responsive-logo">
				<a href="{{ url('/' . $page='index') }}"><img src="{{ config('settings.logo') ? asset('storage/' . config('settings.logo')) : URL::asset('assets/img/brand/favicon.png') }}" class="logo-1" alt="logo"></a>
				<a href="{{ url('/' . $page='index') }}"><img src="{{ config('settings.logo') ? asset('storage/' . config('settings.logo')) : URL::asset('assets/img/brand/favicon.png') }}" class="dark-logo-1" alt="logo"></a>
				<a href="{{ url('/' . $page='index') }}"><img src="{{ config('settings.logo') ? asset('storage/' . config('settings.logo')) : URL::asset('assets/img/brand/favicon.png') }}" class="logo-2" alt="logo"></a>
				<a href="{{ url('/' . $page='index') }}"><img src="{{ config('settings.logo') ? asset('storage/' . config('settings.logo')) : URL::asset('assets/img/brand/favicon.png') }}" class="dark-logo-2" alt="logo"></a>
			</div>
						...
						<div class="main-header-profile bg-primary p-3">
							<div class="d-flex wd-100p">
								...
								<div class="mr-3 my-auto">
									<h6>{{ auth('admin')->user()->name ?? 'No Name'  }}</h6><span>{{ auth('admin')->user()->email ?? 'No Email' }}</span>
								</div>
							</div>
						</div>
